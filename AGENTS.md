...
- Workshop flow is bike-gated: Repairs is the admin/owner decision queue, and Jobs becomes visible to admin/mechanics only after every inspection fault on that bike is decided.
